...
export default function Chat() {
	...
	return (
		<div className="max-w-3xl mx-auto px-6 h-[calc(100vh-3.5rem)] flex flex-col overflow-hidden">
			<div className="flex items-center justify-between py-3 border-b border-zinc-200 dark:border-zinc-800">
				<div>
					<h1 className="text-lg font-semibold">
						ShopMetrics
					</h1>
					<p className="text-zinc-500 dark:text-zinc-500 text-xs mt-0.5">E-commerce Analytics Demo</p>
				</div>
				...
				<div className="flex flex-wrap gap-2 pb-3">
					{[
						...
						<button
							...
							disabled={isLoading}
							className="px-3 py-1.5 rounded-full border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 text-zinc-500 text-xs hover:border-blue-500 transition-colors cursor-pointer disabled:opacity-50"
						>
							{suggestion}
						</button>
					))}
			...
			<div className="border-t border-zinc-200 dark:border-zinc-800">
				<form onSubmit={handleSubmit} className="flex gap-2 py-3">
					<input
						...
						disabled={isLoading}
						className="flex-1 px-4 py-3 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 text-sm outline-none focus:border-blue-500 transition-colors disabled:opacity-50"
					/>
					<button
						type="submit"
